                ...
                <div className="row zed">
                    ...
                    <div className="col-12 zed">
                        <div
                            ...
                            <a className="dropdown">{getText("catalog")} <span><img src={dropdown} alt=""/></span>
                                <span className="wrap">
                            ...
                            <Link onClick={closeBurger} to='/individual-tailoring-service'>{getText("individual")}</Link>
                            <Link onClick={closeBurger} to='/fabrics-for-clothing'>{getText("matolar")}</Link>
                            <Link onClick={closeBurger} to='/about-us'>{getText("about")}</Link>
                            <Link onClick={closeBurger} to='/vacancy'>{getText("vakansiya")}</Link>
                            <Link onClick={closeBurger} to='/feedback'>{getText("contacts")}</Link>
                            <div className="lang">
