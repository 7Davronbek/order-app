      ...
      <div className="HeadNews">
        <div className="container">
                  ...
                  <div className="h_news_box">
                    <div className="h_news_text">
                      <div className="h_news_h">
                        Platformada qanday roʼyxatdan o`tiladi?
                      </div>
                      <div className="h_news_p">
                        “E-auksion” ESMdan roʼyxatdan oʼtish uchun,
                        platformaning bosh sahifasidan “Roʼyxatdan oʼtish”
                        tugmasini bosish orqali roʼyxatdan oʼtiladi.
                      </div>
                    </div>
                    <Link className="h_news_btn_link" to="">
                      <button className="h_news_btn">Batafsil ma’lumot</button>
                    </Link>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
          ...
          <div className="row justify-content-center">
            <div className="col-12">
              <div className="h_news_count_name">Auksionlar hisobi</div>
            </div>
            <div className="col-2">
