                        ...
                        <div className="col-12 d-flex justify-content-center">
                            <div className="reg_box">
                                ...
                                <div className="reg_inp_box">
                                    <img className='reg_inp_img_1' src="/img/icon_lock.png" alt="" />
                                    <img className='reg_inp_img_2' src="/img/icon_view_no.png" alt="" />
                                    <input placeholder='Parolni qayta kiriting' type="text" name="" id="" />
                                </div>
                                <div className="reg_box_h">Tasdiqlash tugmasini bosish orqali, Siz “Maxfiylik siyosati” shartlariga roziligingizni bildirasiz!</div>
                                <Link to="/registration-sign" className="reg_box_link">Tasdiqlash</Link>
                            </div>
                        </div>
                    </div>
                </div>
