      ...
      <div className="container">
        <div className="footer-body">
          ...
          <ul className='footer-list'>
            <li className='footer-item'><a href="">О нас</a></li>
            <li className='footer-item'><a href="">Преимущества</a></li>
          </ul>

          <ul className='footer-list'>
            <li className='footer-item'><a href="">Отзывы</a></li>
            <li className='footer-item'><a href="">Локация</a></li>
          </ul>

          <ul className='footer-list'>
            <li className='footer-item'><a href="">Цены</a></li>
            <li className='footer-item'><a href="">Наши работы</a></li>
            ...
            <div className='social-links'>
              <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                  ...
                  <path d="M15.0938 21.2695C11.3145 21.2695 8.26759 18.2578 8.26173 14.5078C8.25587 10.8164 11.3262 7.79298 15.082 7.79298C18.8496 7.78712 21.9082 10.8047 21.9141 14.5254C21.9141 18.2402 18.8613 21.2637 15.0938 21.2695ZM15.0938 19.1016C17.666 19.1016 19.752 17.0449 19.7461 14.5137C19.7402 12.0059 17.6543 9.95509 15.0938 9.95509C12.5215 9.95509 10.4238 12 10.4238 14.5254C10.4297 17.0566 12.5215 19.1074 15.0938 19.1016Z" fill="white"/>
                  <path d="M22.7051 5.74219C23.4961 5.74219 24.1406 6.41602 24.1406 7.24219C24.1348 8.06836 23.4844 8.73633 22.6934 8.73047C21.9141 8.72461 21.2754 8.05664 21.2754 7.24805C21.2695 6.42187 21.9141 5.74219 22.7051 5.74219Z" fill="white"/>
